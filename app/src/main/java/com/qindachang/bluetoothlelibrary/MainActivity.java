...
public class MainActivity extends AppCompatActivity {
    ...
    private static final byte[] OPEN_STEP_NOTIFY = {0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01};
    ...
    protected void onDestroy() {
        ...
        mBluetoothLe.clearQueue();  //清队发送队列。
    ...
    private void scan() {
        mBluetoothLe.setScanPeriod(5000)//设置扫描时长，单位毫秒
                .setScanWithServiceUUID(SERVICE_UUID)//设置根据服务uuid过滤扫描
                .setScanWithDeviceName("Betterlife_BP")//设置根据设备名称过滤扫描
                .setScanWithDeviceAddress("E5:19:5E:42:EC:FB")
                ...
                .startScan(TAG, this, new OnLeScanListener() {
                    ...
                    public void onScanResult(BluetoothDevice bluetoothDevice, int rssi, ScanRecord scanRecord) {
                        mStringBuilder.append("扫描到设备名：" + bluetoothDevice.getName()+"扫描到设备地址"+bluetoothDevice.getAddress()+ "-信号强度：" + rssi + "\n");
                        tv_text.setText(mStringBuilder.toString());
    ...
    private void connect() {
        mBluetoothLe.setRetryConnectEnable(true)//设置尝试重新连接
                ...
                .startConnect(false, mBluetoothDevice, new OnLeConnectListener() {
                    ...
                    @Override
                    public void onDeviceConnected() {
                        mStringBuilder.append("成功连接！蓝牙名："+mBluetoothDevice.getName()+"\n");
                        mStringBuilder.append("\n");
                        tv_text.setText(mStringBuilder.toString());
                    }
    ...
    private void openAllNotification() {
        mBluetoothLe.enableNotification(true, SERVICE_UUID, new String[]{READ_UUID,HEART_NOTIFICATION_UUID, STEP_NOTIFICATION_UUID});
